...
function AnimatedHero() {
  ...
  const titles = useMemo(
    () => ["cursor for ads", "vibe-marketing for ads", "automation for ads"],
    []
  );
        ...
        <div className="flex gap-8 py-16 md:py-24 items-center justify-center flex-col">
          <div className="flex gap-4 flex-col">
            <h1 className="text-5xl md:text-7xl max-w-3xl tracking-tighter text-center font-bold mb-2">
              <span className="bg-gradient-to-r from-tiktok-blue to-tiktok-red bg-clip-text text-transparent">Automate your</span>
            ...
            <p className="text-xl text-foreground/80 max-w-3xl mx-auto mb-8">
              Adi* our agent houses a rich set of features to automate your marketing 
              efforts across all social media platforms
            </p>
          </div>
